...
var $author$project$Main$GotExercise = function (a) {
...
var $author$project$Main$endpoint = 'http://192.168.0.194:8080';
...
var $author$project$Main$getExerciseList = $elm$http$Http$riskyRequest(
	{
		body: $elm$http$Http$emptyBody,
		expect: A2($elm$http$Http$expectJson, $author$project$Main$GotExercise, $author$project$Types$dailyDecoder),
		headers: _List_Nil,
		method: 'get',
		timeout: $elm$core$Maybe$Nothing,
		tracker: $elm$core$Maybe$Nothing,
		url: $author$project$Main$endpoint + '/get_daily'
	});
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2($author$project$Main$Loading, $author$project$Main$getExerciseList);
};
...
var $author$project$Main$createExecution = function (exercise) {
	return $elm$http$Http$riskyRequest(
		{
			body: $elm$http$Http$jsonBody(
				$author$project$Types$encodeExecution(exercise)),
			expect: $elm$http$Http$expectWhatever($author$project$Main$InsertExecutionStatus),
			headers: _List_Nil,
			method: 'post',
			timeout: $elm$core$Maybe$Nothing,
			tracker: $elm$core$Maybe$Nothing,
			url: $author$project$Main$endpoint + '/insert_execution'
		});
};
	...
	function (msg, model) {
		...
		while (true) {
			switch (msg.$) {
				...
				case 'ViewList':
					return _Utils_Tuple2(model, $author$project$Main$getExerciseList);
				case 'ViewDetail':
					var exercise = msg.a;
					return _Utils_Tuple2(
				...
				case 'CreateExecution':
					...
					return _Utils_Tuple2(
						model,
						$author$project$Main$createExecution(exercise));
				case 'GotExercise':
					var result = msg.a;
					if (result.$ === 'Ok') {
						var daily = result.a;
				...
				default:
					var result = msg.a;
					if (result.$ === 'Ok') {
						var $temp$msg = $author$project$Main$ViewList,
							$temp$model = model;
						msg = $temp$msg;
						model = $temp$model;
						continue update;
...
var $author$project$Main$createRepContainer = F2(
...
var $author$project$Main$ViewDetail = function (a) {
...
var $author$project$Main$exerciseElement = function (exercise) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Events$onClick(
				$author$project$Main$ViewDetail(exercise)),
				$elm$html$Html$Attributes$classList(
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						...
						A2(
							...
							$author$project$Main$createRepContainer,
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick(
								$author$project$Main$CreateExecution(detail))
							]),
						_List_fromArray(
							[
